...
type SayHelloClient interface {
	SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloRespose, error)
}
...
func (c *sayHelloClient) SayHello(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloRespose, error) {
...
type SayHelloServer interface {
	SayHello(context.Context, *HelloRequest) (*HelloRespose, error)
...
func (UnimplementedSayHelloServer) SayHello(context.Context, *HelloRequest) (*HelloRespose, error) {
